...
def get_bgtrace_plot_filepath(kxn, kx_length, version_number):
    return FilePaths.greens_plots+'/G_trace_kxn={}_k_weight={}_kxlen={:.2f}__{}.png'.format(kxn, Params.k_pocket_weighting, kx_length, version_number)


def get_combined_plot_filepath(version_number):
    return FilePaths.combined_plots + '/combined_{}.png'.format(version_number)
